...
pub const enable = true; //if (builtin.is_test) false else build_options.enable_tracy;
pub const enable_allocation = true; //enable and build_options.enable_tracy_allocation;
pub const enable_callstack = true; //enable and build_options.enable_tracy_callstack;
